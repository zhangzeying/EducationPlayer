...
- (void)playBtnClick:(UIButton*)playBtn
{
    ...
    NSString *str = playBtn.selected ? @"1" : @"0";
    [[NSNotificationCenter defaultCenter]postNotificationName:@"PlayStateChange" object:str];
    if ([self.delegate respondsToSelector:@selector(cyVideoToolBarView:)]) {
        [self.delegate cyVideoToolBarView:!playBtn.selected];
    }
}
...
- (void)didDragSlider:(UISlider*)playerSlider
{
    ...
    [[NSNotificationCenter defaultCenter]postNotificationName:@"PlayStateChange" object:@"1"];
...
- (void)didReplay:(UISlider*)playerSlider
{
    ...
    [[NSNotificationCenter defaultCenter]postNotificationName:@"PlayStateChange" object:@"0"];
